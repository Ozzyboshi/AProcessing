...
struct _test TESTS[] = {
    ...
    {.testId = 14, .test_function = fillscanline_test14,  .nbitplanes=2,.nrows=256,.nbyterow=40, .title = "From px 15 to 102 first row with noreset" , .verbose=0}, // Whole first line
