...
unsigned char *filltransformations_test5();
...
struct _test TESTS[] = {
    ...
    {.testId = 5, .test_function = filltransformations_test5, .nbitplanes=1, .nrows=1, .nbyterow=4,.title = "Square rotatedX top left by 180", .verbose=0},
